...
st.set_page_config(page_title=“CAC Analytics Dashboard”, layout=“wide”)
...
d.columns = [“Sex”, “Count”]
fig = px.pie(d, values=“Count”, names=“Sex”, hole=0.4)
...
fig = px.pie(d, values=“Count”, names=“Status”, hole=0.35)
fig.update_layout(height=320)
st.plotly_chart(fig, use_container_width=True)
col3, col4 = st.columns(2)
with col3:
...
fig = px.bar(d, x=“Quarter”, y=“Count”, color=“Fiscal Year”, barmode=“group”)
...
fig = px.pie(d, values=“Count”, names=“Relationship”, hole=0.3)
fig.update_layout(height=340)
st.plotly_chart(fig, use_container_width=True)
...
fig = px.pie(d, values=“Count”, names=“Type”, hole=0.35)
fig.update_layout(height=320)
st.plotly_chart(fig, use_container_width=True)
with col2:
...
fig = px.pie(d, values=“Count”, names=“Method”, hole=0.35)
